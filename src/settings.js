...
export const themePresets = {
  p_dark: {
    bg: "#090909", mBg: "#222222", title: "#321f1f", text: "#f4f4f4",
    sel: "#ffffff", hl: "#1b5d88", tText: "#adadad", cText: "#727272", actCol: "#ffffff"
  },
  p_light: {
    bg: "#ffffff", mBg: "#f9f9f9", title: "#f0f0f0", text: "#333333",
    sel: "#000000", hl: "#007acc", tText: "#666666", cText: "#888888", actCol: "#000000"
  },
  p_parchment: {
    bg: "#f4ecd8", mBg: "#e8ddc0", title: "#e6daba", text: "#4a3623",
    sel: "#5c4033", hl: "#8b5a2b", tText: "#5c4033", cText: "#8b7355", actCol: "#5c4033"
  }
};
...
function setupSettingsModalEvents() {
  ...
  document.getElementById('btn-apply-theme')?.addEventListener('click', () => {
    ...
    if (themePresets[val]) {
      ...
      // ユーザーのカスタムスロット（Slot 1〜3）の場合
      const s = localStorage.getItem(`theme-slot-${val.replace('c_','')}`);
      if (s) { 
        const t = JSON.parse(s); 
        applyThemePreset({ bg: t.bg, mBg: t.mBg||t.bg, title: t.title, text: t.text, sel: t.sel, hl: t.hl||"#007acc", tText: t.tText||"#adadad", cText: t.cText||"#727272", actCol: t.aCol||"#ffffff" }); 
      } else {
        alert("そのスロットは空です");
      }
    }
